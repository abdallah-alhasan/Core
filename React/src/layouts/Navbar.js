                            ...
                            <div className="col-md-12">
                                <div className="topbar-items">
                                    ...
                                    <ul className="widgets">
                                        <li className="region-widget d-none d-lg-inline-flex"><i className="ion-earth"></i> Asia Pacific</li>
                    ...
                    <div className="container">
                        ...
                        <div className="navbar-collapse collapse" id="main-navigation">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item has-menu"><a href="/book-an-appointment">Appointments</a></li>
                                <li className="nav-item has-menu"><a href="/profile">Profile</a></li>
                                <li className="nav-item has-menu"><a href="/About">About</a></li>
                                <li className="nav-item has-menu"><a href="/contact">Contact</a></li>
                                <li className="nav-item has-menu"><a href="/Login">Login</a></li>
                                <li className="nav-item has-menu"><a href="/register">Register</a></li>
